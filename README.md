...
- 所有设备（手机、平板、电脑、手表、电视、电器）都是 Agent 载体
- 所有设备保持一致，共享同一人格
- 都能独立读懂意图，自主服务
- Center 是"灵魂中心" - 仅作为数据备份和同步枢纽
...
- All devices (phone, tablet, computer, watch, TV, appliances) are Agent carriers
- All devices stay consistent, share the same personality
- Each can independently understand intent and serve autonomously
- Center is the "soul center" - only for data backup and sync hub
