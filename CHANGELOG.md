...
## [3.4.0] - 2026-04-07 🔔 Cross-Device Notification
...
**NotificationHub (`notification_hub.go`):**
- 通知创建与发送
- 目标设备智能选择
- 场景感知优化
- 勿扰时段检测
...
**NotificationAction:**
- 通知动作模型
- 支持 open/reply/dismiss/custom 类型
...
| 规则 | 场景 | 消息类型 | 动作 |
|------|------|----------|------|
| Running-Watch | 跑步/走路 | 通知/健康/社交 | 路由到手表 |
| Driving-Delay | 驾驶 | 通知/社交 | 延迟投递 |
| Meeting-Filter | 会议 | 社交(低优先级) | 过滤 |
| Health-Broadcast | 任意 | 健康/告警 | 广播 |
| Sleeping-Quiet | 睡眠 | 通知/社交(低优先级) | 过滤 |
